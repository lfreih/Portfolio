...
<?php $title="SheepSheep - Portfolio Lucie Freihaut"; include '../head.php'; ?>
    ...
    <main class="mt-20">
        ...
        <section class="relative max-w-6xl mx-auto px-6 mt-20 mb-20">
            <div class="relative z-10">
                ...
                <div class="flex flex-col md:flex-row md:text-left gap-12">
        ...
        <section id="realisation" class="max-w-6xl mx-auto px-6 py-20 border-t border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 auto-rows-[320px]">
                ...
                <div class="md:col-span-2 relative bg-[#1D24CA] rounded-3xl p-8 text-white overflow-hidden shadow-lg space-y-4">
                    <!-- <span class="absolute right-0 bottom-0 text-9xl opacity-10 leading-none select-none font">PHP</span> -->
                    <span class="text-[10px] font-bold uppercase tracking-widest opacity-60 mb-4 block">Développement WEB</span>

                    <h3 class="font text-2xl font-bold mb-4">Blog, Highscores & Créateur de cocktails</h3>

                    <p class="text-sm opacity-80 max-w-2xl">
                        Création d'un blog sous forme de timeline pour suivre l'avancement du projet sur les trois pôles : jeu vidéo, graphisme et site web.
                    </p>
                    <p class="text-sm opacity-80 max-w-2xl">
                        Affichage des highscores enregistrés en base de données (MySQL) après chaque partie dont le score fait partie du top 10 global ou de la semaine.
                    </p>
                    <p class="text-sm opacity-80 max-w-2xl">
                        Implémentation d'un formulaire de création de cocktails pour permettre aux joueurs de jouer avec leurs propres cocktails personnalisés dans le jeu vidéo. 
                        Importante phase de réflexion et de tests pour permettre une création intuitive et WYSIWYG (visualiser le cocktail tel qu'il sera en jeu).
                    </p>
                </div>

                <div class="bg-white relative border border-gray-100 rounded-3xl p-8 flex flex-col justify-between shadow-sm">
                    <span class="absolute right-0 bottom-0 text-9xl opacity-5 leading-none select-none font">C#</span>
                    <span class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4">Développement Unity</span>
                    <p class="text-lg font-medium leading-relaxed mb-4">
                    ...
                    <div class="flex items-center gap-3 text-sm text-gray-500">
                        ...
                        <svg class="w-5 h-5 text-[#1D24CA]" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21 16-4 4-4-4"/><path d="M17 20V4"/><path d="m3 8 4-4 4 4"/><path d="M7 4v16"/></svg>
                        Utilisation d'API Platform pour communiquer avec le jeu
                    </div>
                </div>
        ...
        <!-- Gallerie d'images -->
        <section class="max-w-6xl mx-auto px-6 py-20 w-full mb-10">
