    ...
    <main class="mt-20">
        ...
        <section class="relative max-w-7xl mx-auto px-6 mt-12 md:mt-20 mb-12">
            <div class="relative z-10">
                ...
                <div class="">
                    ...
                    <h1 class="font text-4xl md:text-7xl font-black mb-6 tracking-tighter leading-none">Clairtemps</h1>
                </div>
        ...
        <section class="max-w-4xl mx-auto px-6 pb-12 border-b border-gray-100">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div>
                    <p class="text-3xl md:text-4xl font-black text-[#1D24CA] font">15J</p>
                ...
                <div>
                    <p class="text-3xl md:text-4xl font-black text-[#ED7464] font">30H</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
                ...
                <div class="lg:sticky lg:top-32">
                    ...
                    <div class="space-y-12">
                        <div>
                            <h3 class="font-bold text-lg mb-2 uppercase tracking-wide">01. Réflexion sur le front</h3>
                        ...
                        <div>
                            <h3 class="font-bold text-lg mb-2 uppercase tracking-wide">02. API externe</h3>
                            <p class="text-gray-600">
                        ...
                        <div>
                            <h3 class="font-bold text-lg mb-2 uppercase tracking-wide">03. Développement Frontend</h3>
                            <p class="text-gray-600">
                        ...
                        <div>
                            <h3 class="font-bold text-lg mb-2 uppercase tracking-wide">04. Optimisation</h3>
                            <p class="text-gray-600">
