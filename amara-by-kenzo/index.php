    ...
    <main class="mt-20">
        ...
        <section class="relative max-w-7xl mx-auto px-6 mt-12 md:mt-20 mb-12">
            <div class="relative z-10">
                ...
                <div class="">
                    ...
                    <h1 class="font text-4xl md:text-7xl font-black mb-6 tracking-tighter leading-none">Amara by <span class="uppercase">Kenzo</span></h1>
                </div>
        ...
        <section class="max-w-4xl mx-auto px-6 pb-12 border-b border-gray-100">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div>
                    <p class="text-3xl md:text-4xl font-black text-[#1D24CA] font">30s</p>
                    <p class="text-[10px] uppercase tracking-widest font-bold text-gray-400 mt-2">Format Court</p>
                </div>
                <div>
                    <p class="text-3xl md:text-4xl font-black text-[#1D24CA] font">100+</p>
                ...
                <div>
                    <p class="text-3xl md:text-4xl font-black text-[#ED7464] font">10H</p>
        ...
        <section class="max-w-7xl mx-auto px-6 py-16 md:py-24">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
                ...
                <div class="lg:sticky lg:top-32">
                    <h2 class="font text-2xl md:text-3xl font-bold mb-8">Coulisses & <span class="text-[#ED7464]">Contraintes</span></h2>
                    
                    <div class="space-y-12">
                        <div>
                            <h3 class="font-bold text-lg mb-2 uppercase tracking-wide">01. Travail en amont</h3>
                        ...
                        <div>
                            <h3 class="font-bold text-lg mb-2 uppercase tracking-wide">02. Modélisation 3D</h3>
                            <p class="text-gray-600">
                        ...
                        <div>
                            <h3 class="font-bold text-lg mb-2 uppercase tracking-wide">03. Gestion de la lumière</h3>
                            <p class="text-gray-600">
                        ...
                        <div>
                            <h3 class="font-bold text-lg mb-2 uppercase tracking-wide">04. Scène finale</h3>
                            <p class="text-gray-600">
            ...
            <div class="mt-16 flex flex-col md:flex-row gap-10 justify-center">
                <a href="https://www.youtube.com/embed/ij9270Ufi7M?rel=0" target="_blank" 
                ...
                <a href="https://www.youtube.com/embed/FiHjTaWA2ko?rel=0" target="_blank" 
