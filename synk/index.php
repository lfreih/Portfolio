    ...
    <main class="mt-20">
        ...
        <section class="relative max-w-7xl mx-auto px-6 mt-20 mb-12">
            <div class="relative z-10">
                ...
                <div class="">
                    ...
                    <h1 class="font text-5xl md:text-7xl font-black mb-6 tracking-tighter leading-none">SYNK</h1>
                </div>
                ...
                <div class="flex flex-col md:flex-row md:text-left items-center gap-10">
                    ...
                    <!-- <div class="flex-1 w-full h-[200px]">
                        <img src="<?php echo $root; ?>images/projects/synk/logo.png" alt="Logo de SYNK" class="w-full h-full object-cover object-top">
                    </div> -->
                </div>
        ...
        <section class="max-w-4xl mx-auto px-6 pb-12 border-b border-gray-100">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div>
                    <p class="text-4xl font-black text-[#1D24CA] font">A à Z</p>
                ...
                <div>
                    <p class="text-4xl font-black text-[#ED7464] font">SOLO
                    </p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
                ...
                <div class="lg:sticky lg:top-32">
                    ...
                    <div class="space-y-12">
                        ...
                        <div>
                            <h4 class="font-bold text-lg mb-2 uppercase tracking-wide">02. Méthodologie</h4>
                            <p class="text-gray-600">
                        ...
                        <div>
                            <h4 class="font-bold text-lg mb-2 uppercase tracking-wide">03. Détection de bugs</h4>
                            <p class="text-gray-600">
                        ...
                        <div>
                            <h4 class="font-bold text-lg mb-2 uppercase tracking-wide">04. Suite du Développement</h4>
                ...
                <!-- Galery -->
                <div class="space-y-8 h-[1000px] overflow-y-auto pr-4 custom-scrollbar">
